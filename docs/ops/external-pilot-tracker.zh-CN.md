...
|---|---|---|---|---|---|---|---|
| 2026-05-06 | Streamcore server | https://github.com/streamcoreai/streamcore-server/issues/4 | custom platform / realtime voice agent | HTTP / WebSocket / Transcript import | 未确认 | pr_pending_review | 2026-05-12 对方建议走本地测试，不测 live demo；已打开 dev-only `/test-turn` PR 并处理自动审查意见，等待 maintainer review / merge |
...
| 2026-05-08 | kylecampbell LiveKit outbound caller | https://github.com/kylecampbell/livekit-outbound-caller-agent/issues/4 | outbound_leadgen | LiveKit / Twilio / HTTP | 未确认 | dormant | 2026-05-16 dormant review：无 maintainer 回复；不再顶帖，后续仅在对方主动回复时重开 |
| 2026-05-08 | tetratensor LiveKit outbound caller | https://github.com/tetratensor/LiveKit-Outbound-Caller-Voice-Agent/issues/1 | outbound_leadgen | LiveKit SIP / HTTP | 未确认 | dormant | 2026-05-16 dormant review：无 maintainer 回复；不再顶帖，后续仅在对方主动回复时重开 |
| 2026-05-08 | kirklandsig AIReceptionist | https://github.com/kirklandsig/AIReceptionist/issues/12 | restaurant / custom receptionist | HTTP / Transcript import | 未确认 | closed_lost | 2026-05-12 对方关闭为 not planned：暂时没有 dev phone endpoint 或 sanitized transcript bundle |
...
| 2026-05-09 | VoiceBlender | https://github.com/VoiceBlender/voiceblender/issues/28 | outbound_leadgen / platform adapter | REST / Webhook / WebSocket adapter | 未确认 | pr_opened | 2026-05-18 已打开 docs/example-only draft PR https://github.com/VoiceBlender/voiceblender/pull/37，包含 synthetic suite、sanitized transcript、transcript replay 命令和本地 `/test-turn` bridge 形状；等待 maintainer review |
